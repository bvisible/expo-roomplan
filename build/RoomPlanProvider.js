 ...
 */
const RoomPlanContext = createContext(undefined);
/**
 ...
 * ```
 */
export function RoomPlanProvider(props) {
    const { children, ...options } = props;
    const value = useRoomPlanView(options);
    return (<RoomPlanContext.Provider value={value}>
      {children}
 ...
 */
export function useRoomPlanContext() {
    const ctx = useContext(RoomPlanContext);
    if (!ctx) {
        throw new Error("useRoomPlanContext must be used within a RoomPlanProvider");
    }
    return ctx;
}
/**
 ...
 */
export function RoomPlanViewConsumer(props) {
    const { viewProps } = useRoomPlanContext();
    return <RoomPlanView {...viewProps} {...props}/>;
}
//# sourceMappingURL=RoomPlanProvider.js.map